...
impl ReleaseChannel {
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "Zed Camelot Dev Version",
            ReleaseChannel::Nightly => "Zed Camelot Nightly",
            ReleaseChannel::Preview => "Zed Camelot Preview",
            ReleaseChannel::Stable => "Zed Camelot",
        }
    }
